...
These are **intent**. `crates/unluminous-app/tests/snapshots` is a different thing and must not be
...
| `settings_appearance.png` | The Settings window, which is the shape every modal in Unluminous is built from. |
