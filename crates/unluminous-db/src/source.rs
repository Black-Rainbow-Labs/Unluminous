...
impl Engine {
    ...
    pub fn column_types(self) -> &'static [&'static str] {
        match self {
            ...
            Engine::Sqlite | Engine::Inillucent => &["TEXT", "INTEGER", "REAL", "BLOB", "NUMERIC", "BOOLEAN", "DATE", "DATETIME"],
            Engine::Postgres => &[
                "text",
                "varchar(255)",
                "integer",
    ...
    pub fn key_column(self, type_name: &str) -> String {
        ...
        match self {
            Engine::Sqlite | Engine::Inillucent if type_name.eq_ignore_ascii_case("integer") => "INTEGER".to_owned(),
            Engine::Postgres if type_name.eq_ignore_ascii_case("integer") => "integer GENERATED BY DEFAULT AS IDENTITY".to_owned(),
            Engine::Postgres if type_name.eq_ignore_ascii_case("bigint") => "bigint GENERATED BY DEFAULT AS IDENTITY".to_owned(),
