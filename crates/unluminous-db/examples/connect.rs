...
//!
//! ```text
//! cargo run -p unluminous-db --example connect -- "postgres://postgres@localhost:5432/ai" PGPASSWORD
//! cargo run -p unluminous-db --example connect -- C:\jason\dev\unluminous\tasks.db
//! ```
//!
...
use unluminous_db::{Database, Kind};
