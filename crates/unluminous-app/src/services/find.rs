...
//! Unluminous had `Find in Files` on `Ctrl/Cmd+Shift+F` and nothing at all on `Ctrl/Cmd+F`, and no
...
//!
//! Measured on a 2 MB file: `unluminous-app --example frame_cost` does the same scan for the
