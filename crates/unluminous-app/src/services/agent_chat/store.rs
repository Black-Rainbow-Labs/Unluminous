...
use unluminous_chat::base64;
use unluminous_chat::model::{Conversation, Message, Part, Role, ToolCall, Usage};
...
mod tests {
    ...
    fn a_conversation_with_a_picture_in_it_comes_back_byte_for_byte() {
        ...
        answered.tools.push(ToolCall::new("t1", "unluminous_git", "{}"));
    ...
    fn a_store_with_no_folder_does_nothing_at_all() {
        ...
        // `UnluminousApp::load_settings` and `services::file_marks` already keep.
