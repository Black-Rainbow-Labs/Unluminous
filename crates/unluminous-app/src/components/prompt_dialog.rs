//! The one text prompt, and the one confirmation, that the rest of Unluminous asks with.
//!
...
//! [`UnluminousApp::run_action`] decides what a confirmed prompt means, so a prompt cannot do anything by
//! itself.
