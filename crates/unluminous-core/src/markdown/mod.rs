...
//!
//! Unluminous already has everything needed to show formatted text: a styled text model, a layout engine
...
//! Unluminous has no HTML, no box model and no inline layout. Everything a crate gave back would have to
...
/// Markdown turned into text that Unluminous can lay out.
#[derive(Debug, Clone)]
pub struct Preview {
    pub text: Rope,
...
/// Read `source` as Markdown and produce text Unluminous can lay out.
