...
//!
//! A table needs columns of equal width, and Unluminous's layout engine places one glyph after another
...
//! this. And it is what Unluminous already does one step down — the horizontal rule has been forty-eight
