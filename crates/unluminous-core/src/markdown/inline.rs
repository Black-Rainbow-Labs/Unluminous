...
/// that Unluminous cannot draw and drops.
...
///
/// Unluminous has no HTML engine and will not grow one, so a tag is not shown. Four of them have an
...
mod tests {
    ...
    #[test]
    fn a_tag_unluminous_cannot_draw_is_not_shown() {
