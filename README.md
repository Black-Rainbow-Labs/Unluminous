...
| **Eight crates, six with no user interface in them** | which is why most of Unluminous is tested with no window, no graphics card and no fonts | [Architecture](documentation/architecture.md) |
